...
public:
	...
	public:
		...
		HPS::Type				ObjectType() const { return HPS::Type::ExchangeComponent; }
	...
	public:
		...
		HPS::Type				ObjectType() const { return HPS::Type::ExchangeProductOccurrence; }
	...
	public:
		...
		HPS::Type				ObjectType() const { return HPS::Type::ExchangeSheet; }
	...
	public:
		...
		HPS::Type				ObjectType() const { return HPS::Type::ExchangeCADModel; }
	...
	public:
		...
		HPS::Type				ObjectType() const { return HPS::Type::ExchangeCapture; }
	...
	public:
		...
		HPS::Type				ObjectType() const { return HPS::Type::ExchangeFilter; }
	...
	public:
		...
		HPS::Type				ObjectType() const { return HPS::Type::ExchangeImportNotifier; };
	...
	public:
		...
		HPS::Type							ObjectType() const { return HPS::Type::ExchangeTranslationNotifier; };
	...
	public:
		...
		HPS::Type				ObjectType() const { return HPS::Type::ExchangeExportNotifier; };
	...
	public:
		...
		HPS::Type				ObjectType() const { return HPS::Type::ExchangeReloadNotifier; };
	...
	public:
		...
		HPS::Type				ObjectType() const { return HPS::Type::ExchangeConfiguration; }
	...
	public:
		...
		enum class Format
		{
			...
			COLLADA,				//!< COLLADA (DAE) file (<span class='code'>A3DEModellerType::kA3DModellerDAE</span>).  This format requires the "From The Vault" libraries to import.
			...
			ThreeDStudioMax,		//!< Autodesk 3D Studio Max file (<span class='code'>A3DEModellerType::kA3DModeller3DS</span>).  This format requires the "From The Vault" libraries to import.
			...
			WavefrontObject,		//!< Wavefront Object (OBJ) file (<span class='code'>A3DEModellerType::kA3DModellerOBJ</span>).  This format requires the "From The Vault" libraries to import.
		};
		...
		/*! Performs a synchronous 3MF export of the given CADModel with the provided options to a given filename.  An exception will be thrown if a problem is encountered during export.
		...
		* 	\param in_options The options controlling the export of the 3MF data. */
		static void Export3MF(CADModel const & in_cad_model, char const * in_file_name, Export3MFOptionsKit const & in_options);
	...
	public:
		...
		HPS::Type					ObjectType() const { return HPS::Type::ExchangeNURBSConversionOptionsKit; }
		...
		*  This corresponds to the value that will be passed to <a target="_blank" href="http://docs.techsoft3d.com/exchange/latest/build/struct_a3_d_copy_and_adapt_brep_model_data.html#a6f0e7092293f45ec534bae13b48f77c4">A3DCopyAndAdaptBrepModelData::m_bDeleteCrossingUV</a>.
		...
		/*! Sets whether to split closed surfaces.
   		 *  This corresponds to the value that will be passed to <a target="_blank" href="http://docs.techsoft3d.com/exchange/latest/build/struct_a3_d_copy_and_adapt_brep_model_data.html#a0fb05ac8b68b088c0df901a093dd816f">A3DCopyAndAdaptBrepModelData::m_bSplitClosedSurfaces</a>.
		 *	\param in_state Whether to split closed surfaces into faces at the parametric seam and mid-parameter.
		 *	\return A reference to this NURBSConversionOptionsKit. */
		NURBSConversionOptionsKit & SetClosedSurfaceSplitting(bool in_state);

		/*! Sets whether to split periodic surfaces.
		 ...
		 *	\param in_state Whether to split periodic surfaces on parametric seams.
		 *	\return A reference to this NURBSConversionOptionsKit. */
		NURBSConversionOptionsKit & SetPeriodicSurfaceSplitting(bool in_state);
		 ...
		 *	\return A reference to this NURBSConversionOptionsKit. */
		NURBSConversionOptionsKit & UnsetClosedSurfaceSplitting();

		/*! Removes the periodic surface splitting conversion state.
		 *	\return A reference to this NURBSConversionOptionsKit. */
		NURBSConversionOptionsKit & UnsetPeriodicSurfaceSplitting();
		 ...
		 *	\param out_state Whether surfaces will be split by the conversion
		 *	\return <span class='code'>true</span> if a surface splitting conversion setting was specified, <span class='code'>false</span> otherwise. */
		bool ShowClosedSurfaceSplitting(bool & out_state) const;

		/*! Shows the periodic surface splitting conversion setting.
		 *	\param out_state Whether periodic surfaces will be split by the conversion
		 *	\return <span class='code'>true</span> if a face splitting conversion setting was specified, <span class='code'>false</span> otherwise. */
		bool ShowPeriodicSurfaceSplitting(bool & out_state) const;
	...
	/*! The HPS::Exchange::ImportOptionsKit class is a user space object.  It contains settings controlling what and how data is imported via Exchange. Calling HPS::Exchange::ImportOptionsKit::GetDefault() will return an options kit with values found in <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options">here.</a> */
	...
	public:
		...
		HPS::Type					ObjectType() const { return HPS::Type::ExchangeImportOptionsKit; }
		...
		/*! Sets whether to import BRep data from the CAD file.  This corresponds to the value that will be passed to <a target="_blank" href="http://docs.techsoft3d.com/exchange/latest/build/api_ref/struct_a3_d_r_w_params_general_data.html#abdbdcc84388eec9befad25ca29424452">A3DRWParamsGeneralData::m_eReadGeomTessMode</a>.
		 *	\param in_state Whether to import BRep data from the CAD file.
		 *	\return A reference to this ImportOptionsKit.
		 *	\deprecated This function has been superseded by SetBRepMode. 
		 */
		ImportOptionsKit &			SetBRepData(bool in_state);
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-brep-mode">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-solids">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-surfaces">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-wireframes">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-pmi">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-attributes">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-hidden-objects">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-construction-and-references">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-active-filter">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-default-units">Default value</a>
		 */
		 ...
		 *	with this tolerance.
		 *	\param in_tolerance The sewing tolerance to use on the A3DAsmModelFile after importing a file.
		 *	\return A reference to this ImportOptionsKit. */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-pmi-precision">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-pmi-default-units">Default value</a>
		 */
		...
		*/
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-pmi-default-color">Default value</a>
		 */
		...
		*/
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-tessellation-level">Default value</a>
		 */
		 ...
		 *	\param in_accurate_normals Whether to compute surface normals when performing accurate tessellation.  This only applies if <span class='code'>in_type</span> is set to Tessellation::Accuracy::Accurate.
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-tessellation-accuracy">Default value</a>
		 */
		ImportOptionsKit &			SetTessellationAccuracy(Tessellation::Accuracy in_type, bool in_accurate_normals = true);
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-tessellation-preserve-uv-points">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-tessellation-maximum-edge-length">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-catia-v4-logical-root-dir-name">Default value</a>
		 */
		 ...
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-catia-v4-logical-name-search">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-catia-v5-cache">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-unig-refset-count">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-unig-fitted-camera">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-proe-code-page-name">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-proe-dim-tol">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-proe-subpart-name">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-proe-session-color">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-step-name-preference">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-step-code-page-name">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-step-first-color-preference">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-step-sbsms">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-step-orient-heal">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-ifc-code-page-name">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit.
		 *	\sa SetAttributes
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-ifc-attr-xml-file">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-ifc-oho">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-ifc-face-opt">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-ifc-edges">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-face-metadata">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-3dpdf-stream-index">Default value</a>
		 */
		 ...
		 *	\return A reference to this ImportOptionsKit. 
		 *	\sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-import-options-jt-tess-level">Default value</a>
		 */
		 ...
		 *		corresponding to an A3DAsmProductOccurrence.  Note that if the imported file is added along a component path with attributes specified in
		 ...
		 *	ImportNotifier.  Also it is important to note that this option is mutually exclusive with the incremental component path option, i.e., if one is set,
		 ...
		 *	\return A reference to this ImportOptionsKit.
		 *	\deprecated This function has been superseded by UnsetBRepMode. */
		ImportOptionsKit &			UnsetBRepData();
		...
		*	\return A reference to this ImportOptionsKit. */
		 ...
		 *	\param out_state Whether to import BRep data from the CAD file.
		 *	\return <span class='code'>true</span> if a BRep data import setting was specified, <span class='code'>false</span> otherwise.
		 *	\deprecated This function has been superseded by ShowBRepMode. */
		...
		*	\return <span class='code'>true</span> if a multi-process count setting was specified, <span class='code'>false</span> otherwise. */
		 ...
		 *	\param out_accurate_normals Whether to compute surface normals when performing accurate tessellation.  This only applies if <span class='code'>out_type</span> is Tessellation::Accuracy::Accurate.
		...
		*	\return <span class='code'>true</span> if a pmi flipping setting was specified, <span class='code'>false</span> otherwise. */
		 ...
		 *	\return <span class='code'>true</span> if an incremental component paths setting was specified, <span class='code'>false</span> otherwise. */
	...
	/*! The HPS::Exchange::TranslationOptionsKit class is a user space object.  It contains settings controlling what and how data is translated to Parasolid by Exchange. Calling HPS::Exchange::TranslationOptionsKit::GetDefault() will return an options kit with values found in <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-translation-options">here.</a> */
	class EXCHANGE_API TranslationOptionsKit : public SprocketKit
	{
		...
		HPS::Type						ObjectType() const { return HPS::Type::ExchangeTranslationOptionsKit; }
		 ...
		 *	\return A reference to this TranslationOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-parasolid-solids">Default value</a>
		 */
		 ...
		 *	\return A reference to this TranslationOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-parasolid-tess">Default value</a>
		 */
		 ...
		 *	\return A reference to this TranslationOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-parasolid-hidden-obj">Default value</a>
		 */
		 ...
		 *	\param in_tolerance The sewing tolerance.
		 *	\return A reference to this TranslationOptionsKit. */
	 ...
	 *	has BRep data).  Calling HPS::Exchange::ModelFileImportOptionsKit::GetDefault() will return an options kit with values found in <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-model-file-import-options">here.</a> */
	...
	public:
		...
		HPS::Type							ObjectType() const { return HPS::Type::ExchangeModelFileImportOptionsKit; }
		...
		*/
		 ...
		 *	\param in_level The predefined quality of the tessellation that will be generated for BRep data.
		 *	\return A reference to this ModelFileImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-model-file-import-options-tessellation-level">Default value</a>
		 */
		 ...
		 *		This correspond to the (negated) value that will be passed to <a target="_blank" href="http://docs.techsoft3d.com/exchange/latest/build/api_ref/struct_a3_d_r_w_params_tessellation_data.html#a51d14d591da50a1d28fd6a61d7ed7eab">A3DRWParamsTessellationData::m_bDoNotComputeNormalsInAccurateTessellation</a>.
		 *	\return A reference to this ModelFileImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-model-file-import-options-tessellation-accuracy">Default value</a>
		 */
		...
		*/
		 ...
		 *	\param in_state Whether to keep parametric points as texture coordinates when generating the tessellation for BRep data.
		 *	\return A reference to this ModelFileImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-model-file-import-options-tessellation-preserve-uv-points">Default value</a>
		 */
		 ...
		 *	\param in_length The maximum length of triangle edges in the tessellation generated for BRep data.  The value must be non-negative, and if set to <span class='code'>0.0</span>, the length will not be used when generating the tessellation.
		 *	\return A reference to this ModelFileImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-model-file-import-options-tessellation-maximum-edge-length">Default value</a>
		 */
		 ...
		 *	\param in_state Whether to import edges for an IFC file.
		 *	\return A reference to this ModelFileImportOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-model-file-import-options-ifc-edges">Default value</a>
		 */
	...
	public:
		...
		* \param in_that An rvalue reference to an Export3MFOptionsKit to take the underlying object from. */
		...
		HPS::Type ObjectType() const { return HPS::Type::ExchangeExport3MFOptionsKit; }
	...
	/*! The HPS::Exchange::ExportACISOptionsKit class is a user space object.  It contains settings controlling how ACIS data is exported via the Exchange interface. Calling HPS::Exchange::ExportACISOptionsKit::GetDefault() will return an options kit with values found in <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options">here.</a> */
	...
	public:
		...
		HPS::Type						ObjectType() const { return HPS::Type::ExchangeExportACISOptionsKit; }
		 ...
		 *	\return A reference to this ExportACISOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-acis-mm">Default value</a>
		 */
		 ...
		 *	\return A reference to this ExportACISOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-acis-binary">Default value</a>
		 */
	...
	/*! The HPS::Exchange::ExportIGESOptionsKit class is a user space object.  It contains settings controlling how IGES data is exported via Exchange. Calling HPS::Exchange::ExportIGESOptionsKit::GetDefault() will return an options kit with values found in <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options">here.</a> */
	...
	public:
		...
		HPS::Type						ObjectType() const { return HPS::Type::ExchangeExportIGESOptionsKit; }
		 ...
		 *	\return A reference to this ExportIGESOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-iges-analytics-as-nurbs">Default value</a>
		 */
		 ...
		 *	\return A reference to this ExportIGESOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-iges-polyhedrics-to-wire">Default value</a>
		 */
		 ...
		 *	\param in_state Whether to convert solids to a set of independent faces for export.
		 *	\return A reference to this ExportIGESOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-iges-solids-as-faces">Default value</a>
		 */
		 ...
		 *	\param in_state Whether to export hidden objects.
		 *	\return A reference to this ExportIGESOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-iges-hidden-objects">Default value</a>
		 */
		 ...
		 *	\param in_state Whether to export tessellation data.
		 *	\return A reference to this ExportIGESOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-iges-tessellation">Default value</a>
		 */
	...
	/*! The HPS::Exchange::ExportJTOptionsKit class is a user space object.  It contains settings controlling how JT data is exported via Exchange. Calling HPS::Exchange::ExportJTOptionsKit::GetDefault() will return an options kit with values found in <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options">here.</a> */
	...
	public:
		...
		HPS::Type						ObjectType() const { return HPS::Type::ExchangeExportJTOptionsKit; }
		 ...
		 *	\return A reference to this ExportJTOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-jt-content">Default value</a>
		 */
		 ...
		 *	\param in_state Whether to export hidden objects.
		 *	\return A reference to this ExportJTOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-jt-hidden-objects">Default value</a>
		 */
		 ...
		 *	\return A reference to this ExportJTOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-jt-pmi">Default value</a>
		 */
	...
	/*! The HPS::Exchange::ExportParasolidOptionsKit class is a user space object.  It contains settings controlling how Parasolid data is exported via Exchange. Calling HPS::Exchange::ExportParasolidOptionsKit::GetDefault() will return an options kit with values found in <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options">here.</a> */
	...
	public:
		...
		HPS::Type							ObjectType() const { return HPS::Type::ExchangeExportParasolidOptionsKit; }
	...
	/*! The HPS::Exchange::ExportPRCOptionsKit class is a user space object. It contains settings controlling how PRC data is exported via Exchange. Calling HPS::Exchange::ExportPRCOptionsKit::GetDefault() will return an options kit with values found in <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options">here.</a> */
	...
	public:
		...
		HPS::Type					ObjectType() const { return HPS::Type::ExchangeExportPRCOptionsKit; }
		 ...
		 *	\return A reference to this ExportPRCOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-prc-tess">Default value</a>
		 */
		 ...
		 *	\return A reference to this ExportPRCOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-prc-brep">Default value</a>
		 */
		 ...
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-prc-brep-removal">Default value</a>
		 */
		 ...
		 *	\return A reference to this AnnotationKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-prc-attr-removal">Default value</a>
		 */
	...
	public:
		...
		HPS::Type						ObjectType() const { return HPS::Type::ExchangeExportSTEPOptionsKit; }
		 ...
		 *	\return A reference to this ExportSTEPOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-step-format">Default value</a>
		 */
		 ...
		 *	\param in_state Whether to convert analytic surfaces to NURBS surfaces for export.
		 *	\return A reference to this ExportSTEPOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-step-analytics-nurbs">Default value</a>
		 */
		 ...
		 *	\param in_state Whether to convert polyhedrics to wireframe data for export.
		 *	\return A reference to this ExportSTEPOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-step-faceted-as-wireframe">Default value</a>
		 */
		 ...
		 *	\return A reference to this ExportSTEPOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-step-name-shortening">Default value</a>
		 */
	...
	/*! The HPS::Exchange::ExportSTLOptionsKit class is a user space object. It contains settings controlling how STL data is exported via Exchange. Calling HPS::Exchange::ExportSTLOptionsKit::GetDefault() will return an options kit with values found in <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options">here.</a> */
	...
	public:
		...
		HPS::Type					ObjectType() const { return HPS::Type::ExchangeExportSTLOptionsKit; }
		 ...
		 *	\return A reference to this ExportSTLOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-stl-binary">Default value</a>
		 */
		 ...
		 *	\return A reference to this ExportSTLOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-stl-tess">Default value</a>
		 */
		 ...
		 *	\param in_type The accuracy to use for tessellation generation.
		 *	\return A reference to this ExportSTLOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-stl-tess-accuracy">Default value</a>
		 */
		 ...
		 *	\return A reference to this ExportSTLOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-stl-tess-retention">Default value</a>
		 */
		 ...
		 *	\return A reference to this ExportSTLOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-stl-max-edge-length">Default value</a>
		 */
	...
	/*! The HPS::Exchange::ExportU3DOptionsKit class is a user space object. It contains settings controlling how U3D data is exported via Exchange. Calling HPS::Exchange::ExportU3DOptionsKit::GetDefault() will return an options kit with values found in <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options">here.</a> */
	...
	public:
		...
		HPS::Type					ObjectType() const { return HPS::Type::ExchangeExportU3DOptionsKit; }
		 ...
		 *	\return A reference to this ExportU3DOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-u3d-version">Default value</a>
		 */
	...
	public:
		...
		HPS::Type					ObjectType() const { return HPS::Type::ExchangeExportXMLOptionsKit; }
		 ...
		 *	\return A reference to this ExportXMLOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-xml-metadata">Default value</a>
		 */
		 ...
		 *	\return A reference to this ExportXMLOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-xml-transformations">Default value</a>
		 */
		 ...
		 *	\return A reference to this ExportXMLOptionsKit. 
		 *  \sa <a target="_blank" href="../../prog_guide/default_attribute_values.html#exchange-export-options-xml-materials">Default value</a>
		 */
	...
	public:
		...
		HPS::Type						ObjectType() const { return HPS::Type::ExchangeTessellationOptionsKit; }
	...
	*/
	...
	Usage:
	- Click where you want to insert the first measurement point.
	- Click where you want to insert the second measurement point
	- Move the mouse to move the measurement geometry around.
	- Click to position the measurement.
	...
	Usage:
	- Click on the edge you want to measure
	- Move the mouse to move the measurement geometry around.
	- Click again to position the measurement.
	- If the edge you clicked on is part of a cir cle, the circle radius will be measured, otherwise the edge length will be measured.
	...
	Usage:
	- Click on a face
	- Click on a different face, which is not parallel to the first face
	- Move the mouse to move the measurement geometry around.
	- Click again to position the measurement.
	...
	*/
	...
	public:
		...
		* When the user has just inserted the second measurement point, this function allows the user to move the
		* measurement geometry along a specific vector.
		* If the user has selected an already existing measurement, this function allows the measurement geometry
		* to be moved anywhere in the view plane.
		* \param in_state A MouseState object describing the current mouse state.
		* \return <span class='code'>true</span> if the input event was handled, <span class='code'>false</span> otherwise. */
	...
	private:
		...
		public:
			...
			ComponentPath	path;									//the component path to this surface
		};
