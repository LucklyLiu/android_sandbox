...
\htmlonly
*
*<style>.simpleWalkOperator_leftColumn {min-width:225px; font-weight:bold; text-align:right; padding-right:4px;}</style>
*  <h3>Mouse Operation:</h3>
*  <table>
*    <tr><td class="td-bk simpleWalkOperator_leftColumn">Left-button down and move:</td><td class="td-bk">Dollies the camera forward or backward, or Pans the camera left or right based on the mouse movement direction. The movement velocity changes based on how far the mouse is dragged from the starting point.</td></tr>
*    <tr><td class="td-bk simpleWalkOperator_leftColumn">Middle-button down and move:</td><td class="td-bk">Dollies the camera vertically or horizontally based on the mouse movement direction. The movement velocity changes based on how far the mouse is dragged from the starting point.</td></tr>
*    <tr><td class="td-bk simpleWalkOperator_leftColumn">Shift:</td><td class="td-bk">With the Shift key down the forward/backward velocity is ten times faster.</td></tr>
*    <tr><td class="td-bk simpleWalkOperator_leftColumn">Ctrl:</td><td class="td-bk">With the Ctrl key down the forward/backward velocity is ten times slower, and the left/right velocity is 45% slower. </td></tr>
*    <tr><td class="td-bk simpleWalkOperator_leftColumn">Mouse wheel:</td><td class="td-bk">Pans the camera vertically. This will change the tilt direction that the camera is looking, but does not change the direction of forward/backward movement.</td></tr>
*    <tr><td class="td-bk simpleWalkOperator_leftColumn">Shift + mouse wheel:</td><td class="td-bk">Increases or decreases the base velocity of Dolly operations.</td></tr>
* </table>
*
*  <h3>Touch Operation:</h3>
*  <table>
*    <tr><td class="td-bk simpleWalkOperator_leftColumn">Single Finger Drag</td><td class="td-bk">Dollies the camera forward or backward, or Pans the camera left or right based on the touch movement direction. The movement velocity changes based on how far the touch is dragged from the starting point.</td></tr>
*    <tr><td class="td-bk simpleWalkOperator_leftColumn">Two Finger Drag</td><td class="td-bk">Dollies the camera vertically or horizontally based on the touch movement direction. The movement velocity changes based on how far the touch is dragged from the starting point.</td></tr>
*    <tr><td class="td-bk simpleWalkOperator_leftColumn">Shift:</td><td class="td-bk">With the Shift key down the forward/backward velocity is ten times faster.</td></tr>
*    <tr><td class="td-bk simpleWalkOperator_leftColumn">Ctrl:</td><td class="td-bk">With the Ctrl key down the forward/backward velocity is ten times slower, and the left/right velocity is 45% slower. </td></tr>
* </table>
*
...
private:
	...
	bool					Move(HPS::Point const & start_point, HPS::Point const & current_point, int directions, HPS::CameraKit & camera, ScaleFactor const & scale);
