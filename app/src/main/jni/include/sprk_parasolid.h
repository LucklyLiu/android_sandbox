	...
	public:
		...
		*  Corresponds to the PK_face_ignore_t struct. */
		...
		public:
			...
			HPS::Type				ObjectType() const { return HPS::Type::ParasolidComponent; }
			 ...
			 *  Tessellation can only occur at the body or assembly level, so calling this function on
		...
		public:
			...
			HPS::Type				ObjectType() const { return HPS::Type::ParasolidCADModel; }
		...
		public:
			...
			HPS::Type				ObjectType() const { return HPS::Type::ParasolidImportNotifier; };
		...
		/*! The ImportOptionsKit class is a user space object.  It contains settings controlling what and how data is imported via the Parasolid interface. Calling HPS::Parasolid::ImportOptionsKit::GetDefault() will return an options kit with values found in <a href="../../prog_guide/default_attribute_values.html#parasolid-io">here.</a> */
		...
		public:
			...
			HPS::Type					ObjectType() const { return HPS::Type::ParasolidImportOptionsKit; }
			 ...
			 *	\return A reference to this ImportOptionsKit. 
			 *  \sa <a href="../../prog_guide/default_attribute_values.html#parasolid-import-format">Default value</a>
			 */
			 ...
			 *	\return A reference to this ImportOptionsKit. 
			 *  \sa <a href="../../prog_guide/default_attribute_values.html#parasolid-import-user-fields">Default value</a>
			 */
			 ...
			 *	\return A reference to this ImportOptionsKit. 
			 *  \sa <a href="../../prog_guide/default_attribute_values.html#parasolid-import-attr-mismatch">Default value</a>
			 */
			 ...
			 *	\return A reference to this ImportOptionsKit. 
			 *  \sa <a href="../../prog_guide/default_attribute_values.html#parasolid-import-compound-body-beh">Default value</a>
			 */
		...
		public:
			...
			HPS::Type					ObjectType() const { return HPS::Type::ParasolidFacetTessellationKit; }
		...
		public:
			...
			HPS::Type					ObjectType() const { return HPS::Type::ParasolidLineTessellationKit; }
		...
		/*! The ExportOptionsKit class is a user space object. It contains settings controlling what and how data is exported via Parasolid. Default values for the various fields of this class can be found <a href="../../prog_guide/default_attribute_values.html#parasolid-io">here.</a> */
		...
		public:
			...
			HPS::Type					ObjectType() const { return HPS::Type::ParasolidExportOptionsKit; }
			 ...
			 *	\return A reference to this ExportOptionsKit. 
			 *  \sa <a href="../../prog_guide/default_attribute_values.html#parasolid-export-format">Default value</a>
			 */
