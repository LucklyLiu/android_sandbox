...
hps_dir = os.path.abspath(os.path.join(sandbox_dir, '..', '..'))
DEFAULT_OUT_JNI_PATH = os.path.join(sandbox_dir, 'app', 'src', 'main', 'jni')
DEFAULT_IN_USER_MOBILE_SURFACE_H = os.path.join(DEFAULT_OUT_JNI_PATH, 'shared', 'UserMobileSurface.h')
DEFAULT_IN_MOBILE_APP_H = os.path.join(DEFAULT_OUT_JNI_PATH, 'shared', 'MobileApp.h')
DEFAULT_OUT_JAVA_SRC_PATH = os.path.join(sandbox_dir, 'app', 'src', 'main', 'java')
DEFAULT_PACKAGE = 'com.techsoft3d.hps.sandbox'
